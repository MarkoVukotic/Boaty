                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @foreach ($bookings as $single_booking)
                                <tr wire:key="{{$single_booking->id}}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <th scope="row"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <button
                                            onclick="confirm('Are you sure you want to delete the booking') || event.stopImmediatePropagation()"
                                            wire:click="delete({{$single_booking->id}})"
